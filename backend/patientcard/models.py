...
class PatientCard(models.Model):
    card_id = models.AutoField(verbose_name='Картка №', primary_key=True, unique=True, default=100001)
    patient = models.OneToOneField(to='users.Patient', on_delete=models.CASCADE)
